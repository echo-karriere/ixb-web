      ...
      <main>
        ...
        <div className="max-w-7xl w-11/12 mx-auto pl-4 pt-6">
          <div className="flex items-center">
            ...
            <h2 className="pl-6">
              Karrieredagen fortsetter i morgen kl 10:00!
            </h2>
          </div>
          <p>
            Karrieredagene fortsetter i morgen kl. 10:00. Klikk på knappen
            ovenfor for å ta en titt på programmet.{" "}
            <Link
              ...
              target="_blank">
              {" "}
              Du finner inngangen her <i className="ri-external-link-line"></i>
            </Link>
          </p>
